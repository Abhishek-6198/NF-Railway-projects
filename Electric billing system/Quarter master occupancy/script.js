      ...
      success: function(response) {
        ...
        if(response[0]=='['){ // Vac=null
          ...
          if(arr.length!=1){
            ...
            cell13.innerHTML="Date of retirement:"
            cell14.innerHTML=arr[7];

            cell15.innerHTML="Occupied on:"
            cell16.innerHTML=arr[1]
            ...
            document.getElementById("save").style.top="48em";
            document.getElementById("reset").style.top="48em";
            ...
            //input.maxLength=10;
            input.style.textAlign="center";
            document.getElementById("save").style.top="36em";
            document.getElementById("reset").style.top="36em";
          }
        }
        else{
          alert(response);
    ...
    $.ajax({
      ...
      success: function(response) { 
        ...
        if(response[0]=='['){
          ...
          if(arr.length==5){ //employee doesn't have any occupied quarters
            count3+=1;
            //console.log("count3");
            var row = table.insertRow(7);
            var cell1 = row.insertCell(0);
            ...
            cell9.innerHTML="Date of retirement:";
            cell10.innerHTML=arr[4];

            cell11.innerHTML="<b>Date of occupation:</b>";
          ...
          else if(arr.length>5){ //employee has occupied quarters
            count4+=1;
            //console.log("count4");
            input.id="vac";
            ...
            cell2.innerHTML=arr[5];

            cell3.innerHTML="Occupied on:";
            cell4.innerHTML=arr[6];
            ...
            input.addEventListener("change",() => check_date());
            document.getElementById("save").style.top="52em";
            document.getElementById("reset").style.top="52em";
...
function check_date(){
  ...
  var dateparts2=document.getElementById("quarter_details").rows[12].cells.item(1).innerHTML;
