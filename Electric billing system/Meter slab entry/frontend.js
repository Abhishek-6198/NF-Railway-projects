                ...
                success:function(response){
                    if(!response.includes("_")){
                        if(!response.includes("Close")){
                            ...
                            var index=0;
                            if(confirm("Please close the latest slab(s) to proceed")==true){
                                for(var i=0; i<table1.rows.length; i++){
                                    if(table1.rows[i].cells.item(3).innerHTML==""){
                                        index=i;
                                        break;
                                    }
                                }
                                table1.rows[index].scrollIntoView(true);
                            }
