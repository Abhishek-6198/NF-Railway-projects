                    ...
                    if($data1[2]=="" && $data1[4]==""){
                        ...
                        if ($result->num_rows == 0) {
                            $stmt = $con->prepare("INSERT INTO `electric rate table`(`Load (in KW)`,`From Date`,`from_unit`,`Rate/unit`,`Unit type`,`Fixed charge`)
                                                    VALUES (?,?,?,?,?,?)");
                            $stmt->bind_param("isissi",$data1[0],$data1[1],$data1[3],$data1[5],$data1[6],$data1[7]);
                            $stmt->execute();
                        }
                    ...
                    elseif($data1[2]=="" || $data1[4]==""){
                        if($data1[2]==""){
                            ...
                            if ($result->num_rows == 0) {
                                $stmt = $con->prepare("INSERT INTO `electric rate table`(`Load (in KW)`,`From Date`,`from_unit`,`to_unit`,`Rate/unit`,`Unit type`,`Fixed charge`)
                                                        VALUES (?,?,?,?,?,?,?)");
                                $stmt->bind_param("isiissi",$data1[0],$data1[1],$data1[3],$data1[4],$data1[5],$data1[6],$data1[7]);
                                $stmt->execute();
                            }
                        }
                        elseif($data1[4]==""){
                            ...
                            if ($result->num_rows == 0) {
                                $stmt = $con->prepare("INSERT INTO `electric rate table`(`Load (in KW)`,`From Date`,`To Date`,`from_unit`,`Rate/unit`,`Unit type`,`Fixed charge`)
                                                        VALUES (?,?,?,?,?,?,?)");
                                $stmt->bind_param("ississi",$data1[0],$data1[1],$data1[2],$data1[3],$data1[5],$data1[6],$data1[7]);
                                $stmt->execute();
                            }
                        }
                    }
                        ...
                        if ($result->num_rows == 0) {
                            $stmt = $con->prepare("INSERT INTO `electric rate table`(`Load (in KW)`,`From Date`,`To Date`,`from_unit`,`to_unit`,`Rate/unit`,`Unit type`,`Fixed charge`)
                                                    VALUES (?,?,?,?,?,?,?,?)");
                            $stmt->bind_param("issiissi",$data1[0],$data1[1],$data1[2],$data1[3],$data1[4],$data1[5],$data1[6],$data1[7]);
                            $stmt->execute();
                        }
                    }    
                }
            ...
            if(!$connection)
                ...
                if ($result->num_rows > 0) {
                    if($_POST["to_date"]=="" && $_POST["to_unit"]==""){
                        ...
                        $stmt->bind_param("isissi",$_POST["load"],$_POST["from_date"],$_POST["from_unit"],$_POST["rate"],$_POST["type"],$_POST["fcharge"]);
                        if($stmt->execute()){
                    ...
                    elseif($_POST["to_date"]=="" || $_POST["to_unit"]==""){
                        if($_POST["to_date"]==""){
                            ...
                            $stmt->bind_param("isiissi",$_POST["load"],$_POST["from_date"],$_POST["from_unit"],$_POST["to_unit"],$_POST["rate"],$_POST["type"],$_POST["fcharge"]);
                            if($stmt->execute()){
                                //echo "Updated rate table";
                                $sql="SELECT * from `electric rate table` WHERE `Sl_No`=".$_POST["sl_no"]."";
                                $result = $con->query($sql);
                        ...
                        elseif($_POST["to_unit"]==""){
                            ...
                            $stmt->bind_param("ississi",$_POST["load"],$_POST["from_date"],$_POST["to_date"],$_POST["from_unit"],$_POST["rate"],$_POST["type"],$_POST["fcharge"]);
                            if($stmt->execute()){
                                //echo "Updated rate table";
                                $sql="SELECT * from `electric rate table` WHERE `Sl_No`=".$_POST["sl_no"]."";
                                $result = $con->query($sql);
                        ...
                        $stmt->bind_param("issiissi",$_POST["load"],$_POST["from_date"],$_POST["to_date"],$_POST["from_unit"],$_POST["to_unit"],$_POST["rate"],$_POST["type"],$_POST["fcharge"]);
                        if($stmt->execute()){
                            //echo "Updated rate table";
                            $sql="SELECT * from `electric rate table` WHERE `Sl_No`=".$_POST["sl_no"]."";
                            $result = $con->query($sql);
