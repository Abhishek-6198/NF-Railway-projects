        ...
        if($_POST["input"]=="qtr_master(wo id)"){
            ...
            if(!$connection)
                ...
                foreach($data as $d){
                    ...
                    if(count($data1)==6){
                        $id="";
                        $sq="SELECT * FROM `quarter_master_entry` WHERE `Qtr_No`='".$data1[2]."' AND `Colony_code='".$data1[3]."'";
                        $res = $con->query($sq);
                        if($res->num_rows>0){
                            ...
                            if($res->num_rows>0){
                                ...
                                if($result->num_rows>0){
                                    ...
                                    $unix_date = ($excel_date - 25569) * 86400;
                                    $data1[4]= gmdate("d/m/Y", $unix_date);
                                    $excel_date = $data1[5]; 
                                    $unix_date = ($excel_date - 25569) * 86400;
                                    $excel_date = 25569 + ($unix_date / 86400);
                                    $unix_date = ($excel_date - 25569) * 86400;
                                    $data1[5]= gmdate("d/m/Y", $unix_date);
                                    $statement->bind_param("ssss",$data1[0],$data1[1],$data1[4],$data1[5]);
                                    if($statement->execute())
                                        $count+=1;
                                    $statement->close();
                                }
                                    ...
                                    $unix_date = ($excel_date - 25569) * 86400;
                                    $data1[5]= gmdate("d/m/Y", $unix_date);
                                    $stmt->bind_param("sssss", $data1[0],$data1[1],$id,$data1[4],$data1[5]);
                                    if($stmt->execute())
                                        $count1+=1;
                                    $stmt->close();
                                }
                        ...
                        if($res->num_rows>0){
                            ...
                            if($res->num_rows>0){
                                ...
                                if($result->num_rows>0){
                                    ...
                                    $unix_date = ($excel_date - 25569) * 86400;
                                    $data1[4]= gmdate("d/m/Y", $unix_date);
                                    $statement->bind_param("ssss",$data1[0],$data1[1],$id,$data1[4]);
                                    if($statement->execute())
                                        $count+=1;
                                    $statement->close();
                                }
                                    ...
                                    $unix_date = ($excel_date - 25569) * 86400;
                                    $data1[4]= gmdate("d/m/Y", $unix_date);
                                    $stmt->bind_param("ssss", $data1[0],$data1[1],$id,$data1[4]);
                                    if($stmt->execute())
                                        $count1+=1;
                                    $stmt->close();
