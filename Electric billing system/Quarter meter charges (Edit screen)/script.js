        ...
        $.ajax({
            ...
            success:function(response){
                ...
                if(response[0]=="["){
                    ...
                    cell8.innerHTML = "<b>Current Date:</b>";
                    ...
                    for(var i=0; i<x/14; i++){
                        ...
                        cell.innerHTML=arr[i][13];
                        ++count;
                        cell1.innerHTML=arr[i][1];
                        ++count;
                        cell2.innerHTML=arr[i][2];
                        ++count;
                        cell3.innerHTML=arr[i][12];
                        ++count;
                        ...
                        cell9.innerHTML=arr[i][8];
                        ++count;
                        cell10.innerHTML=arr[i][9];
                        ++count;
                        cell11.innerHTML=arr[i][10];
                        ++count;
                        cell12.innerHTML=arr[i][11];
                        qtrid.push(arr[i][0]);
                        count=0;
                        ++k;
                    }
                            ...
                            if(date.length!=12){
                                if(item.value.length==10){
                                    if(date.includes(arr[parseInt(arr1[1])-1])){
                                        document.getElementById("colony_name").disabled=true;
                                        var date= item.value;
                                        var date1=table.rows[index+1].cells.item(7).innerHTML;
                                        const d=date.split("/");
                                        ...
                                        if((curr>prev)&&(document.getElementsByClassName("current_read")[index].value>document.getElementsByClassName("previous_read")[index].value)){
                                            //console.log(curr>prev);
                                            //console.log(document.getElementsByClassName("current_read")[index].value>table.rows[index+1].cells.item(4).innerHTML);
                                            if(!flag1)
                                                alert("Please press ENTER key after modifying the current meter reading and date");
                                            flag1=true;
                                            charge1=document.getElementsByClassName("current_read")[index].value-parseInt(document.getElementsByClassName("previous_read")[index].value);
                                            //console.log(charge1);
                                            table.rows[index+1].cells.item(9).innerHTML=document.getElementsByClassName("current_read")[index].value-parseInt(document.getElementsByClassName("previous_read")[index].value);
                                            var temp=[];
                                            ...
                                            table.rows[index+1].cells.item(12).innerHTML=0;
                    ...
                    document.querySelectorAll('.current_read').forEach((item,index) => {
                        ...
                        item.addEventListener('change', event => {
                                ...
                                if(curr<=prev || item.value<=parseInt(document.getElementsByClassName("previous_read")[index].value) || date.length===0){
                                    ...
                                    var temp=[];
                                    if(!flag1)
                                        alert("Please press Numpad ENTER key after modifying the current meter reading and date");
                                    flag1=true;
                                ...
                                document.querySelectorAll('.current_read').forEach((item,index) => {
                                    if(item.value.toString().length>0 && document.getElementsByClassName("current_date")[index].value.length>0){
                                        if(table.rows[index+1].style.backgroundColor=="rgb(118, 230, 238)"){
                                            ...
                                            arr3.push(table.rows[index+1].cells.item(12).innerHTML);
                    ...
                    alert("No quarters found. Please calculate the meter charges in the entry screen for this colony and retry again");
                    //alert(response);
        ...
        if(array.length!=0 && arr2.length!=0){
            ...
            success:function(response){
                if(response[0]=='['){
                    ...
                    var x= arr3.length*3;
                    for(var i=0; i<x/3; i++){
                        table.rows[arr2[i]+1].cells.item(10).innerHTML=arr3[i][2];
                        table.rows[arr2[i]+1].cells.item(11).innerHTML=arr3[i][1];
                        table.rows[arr2[i]+1].cells.item(12).innerHTML=arr3[i][0];
                    }
                    array=[];
                    arr2=[];
                }
