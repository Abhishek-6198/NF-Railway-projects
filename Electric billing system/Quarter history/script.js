...
if (n==null)
    ...
    if(key=="emp"){
            ...
            if(document.getElementById("emp_id").value!=""){
                ...
                success:function(response){
                    if(response[0]=='['){
                        ...
                        cell0.innerHTML="<b>BookNo</b>";
                        cell1.innerHTML="<b>PageNo</b>";
                        cell2.innerHTML="<b>QtrNo</b>";
                        cell3.innerHTML="<b>QtrType</b>";
                        cell4.innerHTML="<b>ColonyName</b>";
                        cell5.innerHTML="<b>Occupied by</b>";
                        cell6.innerHTML="<b>Occupied on</b>";
                        cell7.innerHTML="<b>Vacated on</b>";
                        ...
                        for(var i=0; i<len/8; i++){
                            ...
                            cell0.innerHTML=arr[i][6];
                            cell1.innerHTML=arr[i][7];
                            cell2.innerHTML=arr[i][0];
                            cell3.innerHTML=arr[i][1];
                            cell4.innerHTML=arr[i][2];
                            cell5.innerHTML=arr[i][3];
                            cell6.innerHTML=arr[i][4];
                            cell7.innerHTML=arr[i][5];
        ...
        cell4.innerHTML="<b>Book no:</b>&ensp;";
        cell4.style.textAlign="center";

        cell5.innerHTML="<b>Page no:</b>&ensp;";
        ...
        selectList3.id = "book_no";
        selectList3.style.width="80%";
        selectList3.style.textAlign="center";

        var selectList4 = document.createElement("select");
        selectList4.id = "page_no";
        selectList4.style.width="80%";
        selectList4.style.textAlign="center";

        cell1.appendChild(selectList);
        cell2.appendChild(selectList1);
        cell3.appendChild(selectList2);
        cell4.appendChild(selectList3);
        cell5.appendChild(selectList4);
        cell1.style.textAlign="center";
        cell2.style.textAlign="center";
        cell3.style.textAlign="center";
        cell4.style.textAlign="center";
        ...
        selectList3.addEventListener("click",function(){
            let $select = $("#book_no");
            //refresh_colony_type();
            $.ajax({
              url: 'backend.php',
        ...
        selectList4.addEventListener("click",function(){
            let $select = $("#page_no");
            //refresh_colony_type();
            $.ajax({
              url: 'backend.php',
        ...
        document.getElementById("submit").addEventListener("click", function(event) {
            if(document.getElementById("c_name").value!="" && document.getElementById("c_type").value!="" && document.getElementById("qrtr_no").value!="" && document.getElementById("book_no").value!="" && document.getElementById("page_no").value!=""){
                    while(table1.rows.length>0){
                        table1.deleteRow(0);
                    }
                    $.ajax({
