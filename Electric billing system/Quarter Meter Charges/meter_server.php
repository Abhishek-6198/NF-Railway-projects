        ...
        elseif($_POST["input"] == "page"){
            if(!$connection)
                ...
                if ($result->num_rows > 0) {
                    ...
                    $sql = "SELECT * from quarter_master_entry WHERE Colony_code='".$code."' AND `Qtr_type`='".$_POST["type"]."' AND `Book_no`='".$_POST["book"]."'";
                    $result = $con->query($sql);
                    if ($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
        ...
        elseif($_POST["input"] == "is it registered?"){
            ...
            if(!$connection)
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        if($_POST["c_page"]!="default")
                            $sql = "SELECT * from `quarter_master_entry` WHERE `Colony_code`='".$code."' AND `Qtr_type`='".$_POST["c_type"]."' AND `Book_no`='".$_POST["c_book"]."' AND `Page_no`='".$_POST["c_page"]."'";
                        else
                            $sql = "SELECT * from `quarter_master_entry` WHERE `Colony_code`='".$code."' AND `Qtr_type`='".$_POST["c_type"]."' AND `Book_no`='".$_POST["c_book"]."'";
                        $result = $con->query($sql);
                        if ($result->num_rows > 0) {
                            ...
                            for($x=0; $x<count($qtrid); $x++){
                                ...
                                array_push($temp,$qtrid[$x],$empno,$qtrno[$x],$empname,$read,$date,$retirement);
        ...
        elseif($_POST["input"]=="calculate_charges"){ 
            ...
            if(!$connection)
                ...
                foreach($data as $d){
                    ...
                    $months=intdiv(count($total_period),30);
                    if(count($total_period)%30!=0){   
                        $months+=1;
                    }
                    $fixed_charge=$months*$fixed_charge;
