            ...
            reader.onload = function(event){
                ...
                if(sheet_data.length > 0)
                {
                    if(sheet_data[0][0]=="Qtr_No" || sheet_data[0][1]=="Qtr_No" || sheet_data[0][5]=="Meter capacity (in KW)" || sheet_data[0][6]=="Meter capacity (in KW)"){ //for quarter_master_entry
                        ...
                        if(sheet_data[0][1]=="EmpName" && sheet_data[0][2]=="Qtr_No" && sheet_data[0][3]=="Colony_code" && sheet_data[0][4]=="Occupation Date"){
                            flag=true;
                        }
                        else if(sheet_data[0][1]=="Name" && sheet_data[0][2]=="Designation" && sheet_data[0][3]=="BillUnit" && sheet_data[0][4]=="Station" && sheet_data[0][5]=="DOR")
                            flag=true;
                    }
